...
# ==========================================
def open_browser():
    """Espera a que el servidor arranque y abre el navegador por defecto."""
    time.sleep(1.5) # Pequeña pausa para asegurar que uvicorn está listo
    print("Abriendo el navegador web en http://localhost:8000 ...")
...
if __name__ == "__main__":
    print("Iniciando la aplicación Comparador de Coches...")
    ...
    if SUPABASE_URL == "TU_SUPABASE_URL_AQUI" or SUPABASE_KEY == "TU_SUPABASE_KEY_AQUI":
        ...
        print("La aplicación se abrirá, pero no mostrará ningún coche.")
        print("="*60)
        time.sleep(3)
        
    # Iniciamos el hilo que abrirá el navegador
    threading.Thread(target=open_browser, daemon=True).start()
    
    # Iniciamos el servidor de forma síncrona (bloquea el script principal)
